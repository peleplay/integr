...
Hence, interaction graphs can be used as a tool for understadning the most important interactions and selection of the attributes suitable for grouping/including in a machine learning model.
...
It only requiers an interaction graph object as an input. Here the result of the previous step is used.
